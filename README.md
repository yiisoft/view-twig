...
Also add the parameters for `WebView` and `Environment` to `config/common/params.php`:
...
<html lang="en">
    ...
    <div class="footer">
        <div class="footer_copyright">
            <a href="https://www.yiiframework.com/" target="_blank" rel="noopener">
                © {{ "now"|date("Y") }}  {{ applicationParams.name }}
            </a>
        </div>
...
```twig
{% do this.setTitle(applicationParams.name) %}
